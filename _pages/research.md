...
### Spatial transcriptomics![]({{ site.url }}{{ site.baseurl }}/images/slider7001400/spatial_revise.png){: style="width: 250px; float: right; margin: 0px 10px"} 
...
![]({{ site.url }}{{ site.baseurl }}/images/slider7001400/cancer_revise.png){: style="width: 70%; float: center; margin: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/slider7001400/tools_revise.png){: style="width: 70%; float: center; margin: 10px"}
